; Menu con opciones de sumar y restar numeros de un solo digito
...
main proc far
     ...
     OP1: ; opcion 1, rango de la primera opcion
          rango 27, 52, SUMAR
     OP2: ; rango de la opcion 2
          rango 27, 52, RESTAR
     OP3:
          rango 27, 52, EXIT
     SUMAR:
